...
import { MovieDataType } from "../../assets/icons/data";
                ...
                <Grid container spacing={1}>
                    <Grid item>
                        <img
                            ...
                            alt=""
                            style={{ width: "100%", height: "180px", borderRadius: "8px", objectFit: "contain" }}
                        />
                    </Grid>
                    <Grid item xs={8}>
                    ...
                    <Grid item xs={2} sx={{ position: "absolute", top: 0, left: "20px" }}>
                        <Box
                            sx={{
                                display: "flex",
